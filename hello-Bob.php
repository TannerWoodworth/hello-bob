 ...
 */
/*
Plugin Name: Hello Bob
Plugin URI: https://github.com/TannerWoodworth/hello-bob
Description: When activated you will randomly see a quote from Bob Ross in the upper right of your admin screen on every page.
Author: Tanner Woodworth
Version: 1.0
Author URI: http://tannerwoodworth.com/
*/

function hello_bob_get_quote() {
	$quote = "That'll be our little secret.
...
function hello_bob() {
	$chosen = hello_bob_get_quote();
	echo "<p id='bob'>$chosen</p>";
}

// Now we set that function up to execute when the admin_notices action is called
add_action( 'admin_notices', 'hello_bob' );
